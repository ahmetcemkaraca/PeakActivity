...
Bu dosya, PeakActivity projesinin genel bağlamını ve AI agent'ların takip etmesi
gereken temel yönergeleri tanımlar.

## Proje Vizyonu

PeakActivity, ActivityWatch'ın güçlü veri toplama altyapısını kullanarak,
kullanıcıların sadece zamanlarını nereye harcadıklarını görmelerini değil, aynı
zamanda üretkenliklerini, odaklanma kalitelerini ve dijital refahlarını proaktif
olarak artırmalarını sağlayan kapsamlı bir çözümdür.
