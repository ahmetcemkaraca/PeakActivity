...
class AWQProcessException(AWQtException):
    ...
    def __init__(self, message: str, process_name: str = "", exit_code: Optional[int] = None, details: Optional[Dict[str, Any]] = None):
        super().__init__(message, details)
...
class AWConnectionException(AWNetworkException):
    ...
    def __init__(self, message: str, host: str = "", port: Optional[int] = None, timeout: Optional[float] = None, details: Optional[Dict[str, Any]] = None):
        super().__init__(message, details)
        self.host = host
        self.port = port
...
class AWX11Exception(AWDisplayException):
    ...
    def __init__(self, message: str, display_name: str = "", details: Optional[Dict[str, Any]] = None):
        super().__init__(message, details)
...
class AWFileException(AWException):
    ...
    def __init__(self, message: str, file_path: str = "", operation: str = "", details: Optional[Dict[str, Any]] = None):
        super().__init__(message, details)
...
class AWDependencyException(AWSetupException):
    ...
    def __init__(self, message: str, dependency_name: str = "", required_version: str = "", details: Optional[Dict[str, Any]] = None):
        super().__init__(message, details)
