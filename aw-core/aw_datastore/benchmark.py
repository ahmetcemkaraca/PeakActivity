...
def temporary_bucket(ds):
    ...
    try:
        ...
        # Bucket doesn't exist or invalid bucket_id - this is expected
        pass
    except (OSError, IOError) as io_e:
        # Storage I/O errors
        logger.warning("Storage error during bucket cleanup: %s", io_e)
    ...
    try:
        ...
        # Bucket doesn't exist or invalid bucket_id
        pass
    except (OSError, IOError) as e:
        # Storage I/O errors
        logger.warning("Storage error during bucket cleanup: %s", e)
        pass
