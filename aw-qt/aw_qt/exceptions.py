...
class AWQProcessTimeoutException(AWQProcessException):
    ...
    def __init__(
        self, message: str, timeout_seconds: Optional[float] = None, **context: Any
    ):
...
class AWGuiException(AWQtException):
    ...
    def __init__(self, message: str, widget_name: Optional[str] = None, **context: Any):
...
class AWManagerException(AWQtException):
    ...
    def __init__(
        ...
        **context: Any,
        ...
        super().__init__(
            message, module_name=module_name, operation=operation, **context
        )
